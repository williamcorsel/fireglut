/*
 * File containing various Vector and Matrix classes used in the program
 * Classes are taken from Workshop 2 of the Computer Graphics 2019 course at Leiden University
 */
